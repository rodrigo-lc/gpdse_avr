...
#include "twiSlave.h"
#if __TWI_SLAVE_H != 10
#error Error 101 - Version mismatch on header and source code files (twiSlave).
#endif
...
static volatile uint8 twiBufferIndex = 0;
static volatile uint8 twiBufferSize = 0;
static volatile uint8 twiCommIndex = 0;
static volatile uint8 twiBusy = 0;
